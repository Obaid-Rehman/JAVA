...
/**
 * This is a model class for PrepaidCard type.
 */
public class PrepaidCard {
    ...
    /**
     * Converts this PrepaidCard into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PrepaidCard [" + "country=" + country + ", token=" + token + ", status=" + status
                + ", createdOn=" + createdOn + ", currency=" + currency + ", cardPersonalization="
                + cardPersonalization + ", cardPackage=" + cardPackage + ", cardNetwork="
                + cardNetwork + ", expires=" + expires + ", cardNumber=" + cardNumber + ", cvv="
                + cvv + "]";
    }

    /**
     * Builds a new {@link PrepaidCard.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PrepaidCard.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PrepaidCard}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PrepaidCard} object using the set fields.
         * @return {@link PrepaidCard}
         */
        public PrepaidCard build() {
            return new PrepaidCard(country, token, status, createdOn, currency, cardPersonalization,
                    cardPackage, cardNetwork, expires, cardNumber, cvv);
        }
    }
}
