...
/**
 * This is a model class for UserBase type.
 */
public class UserBase {
    ...
    /**
     * Converts this UserBase into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "UserBase [" + "phoneNumber=" + phoneNumber + ", mobileNumber=" + mobileNumber
                ...
                + taxResidentStatus + ", currency=" + currency + "]";
    }

    /**
     * Builds a new {@link UserBase.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link UserBase.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link UserBase}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link UserBase} object using the set fields.
         * @return {@link UserBase}
         */
        public UserBase build() {
            return new UserBase(phoneNumber, mobileNumber, phoneNumberCountry, mobileNumberCountry,
                    firstName, lastName, dateOfBirth, businessName, businessOperatingName,
                    ...
                    businessType, driverLicenseId, passportId, governmentIdType, governmentId,
                    addressLine1, addressLine2, addressLine3, addressLine4, addressLine5, city,
                    region, country, postalCode, premiseNumber, addressType, email, employerId,
                    gender, userType, programUserId, language, countryOfBirth, countryOfNationality,
                    occupation, taxResidentStatus, currency);
        }
    }
}
