...
/**
 * This is a model class for PaymentRequest type.
 */
public class PaymentRequest {
    ...
    /**
     * Converts this PaymentRequest into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "PaymentRequest [" + "amount=" + amount + ", currency=" + currency + ", sourceToken="
                + sourceToken + ", destinationToken=" + destinationToken + ", notes=" + notes
                + ", memo=" + memo + ", purpose=" + purpose + ", clientPaymentId=" + clientPaymentId
                + ", autoAcceptQuote=" + autoAcceptQuote + ", notBefore=" + notBefore
                + ", notAfter=" + notAfter + "]";
    }

    /**
     * Builds a new {@link PaymentRequest.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link PaymentRequest.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link PaymentRequest}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link PaymentRequest} object using the set fields.
         * @return {@link PaymentRequest}
         */
        public PaymentRequest build() {
            return new PaymentRequest(amount, currency, sourceToken, destinationToken, notes, memo,
                    purpose, clientPaymentId, autoAcceptQuote, notBefore, notAfter);
        }
    }
}
