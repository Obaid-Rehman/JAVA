...
/**
 * This is a model class for TransferResponse type.
 */
public class TransferResponse {
    ...
    /**
     * Converts this TransferResponse into string format.
     * @return String representation of this class
     */
    @Override
    public String toString() {
        return "TransferResponse [" + "sourceToken=" + sourceToken + ", destinationToken="
                + destinationToken + ", notes=" + notes + ", memo=" + memo + ", destinationAmount="
                + destinationAmount + ", destinationCurrency=" + destinationCurrency
                + ", clientTransferId=" + clientTransferId + ", token=" + token + ", sourceAmount="
                + sourceAmount + ", sourceCurrency=" + sourceCurrency + ", status=" + status
                + ", fx=" + fx + ", links=" + links + "]";
    }

    /**
     * Builds a new {@link TransferResponse.Builder} object.
     * Creates the instance with the state of the current model.
     * @return a new {@link TransferResponse.Builder} object
     */
    ...
    /**
     * Class to build instances of {@link TransferResponse}.
     */
    public static class Builder {
        ...
        /**
         * Builds a new {@link TransferResponse} object using the set fields.
         * @return {@link TransferResponse}
         */
        public TransferResponse build() {
            return new TransferResponse(sourceToken, destinationToken, notes, memo,
                    destinationAmount, destinationCurrency, clientTransferId, token, sourceAmount,
                    sourceCurrency, status, fx, links);
        }
    }
}
