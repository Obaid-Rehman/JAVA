...
public class User {
    ...
    public String toString() {
        return "User [" + "phoneNumber=" + phoneNumber + ", mobileNumber=" + mobileNumber
    ...
    public static class Builder {
         ...
         */
        public User build() {
            return new User(phoneNumber, mobileNumber, phoneNumberCountry, mobileNumberCountry,
                    ...
                    occupation, taxResidentStatus, currency, token, status, createdOn);
        }
    }
}
