...
public class BankAccount {
    ...
    public static class Builder {
        ...
        public BankAccount build() {
            return new BankAccount(token, status, createdOn, bankAccountOwnershipType, type, fields,
                    bankCurrency, bankCountry, description);
        }
    }
}
