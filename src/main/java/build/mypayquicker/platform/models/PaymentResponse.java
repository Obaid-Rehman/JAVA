...
public class PaymentResponse {
    ...
    public String toString() {
        return "PaymentResponse [" + "amount=" + amount + ", currency=" + currency
                + ", sourceToken=" + sourceToken + ", destinationToken=" + destinationToken
                + ", notes=" + notes + ", memo=" + memo + ", purpose=" + purpose
                + ", clientPaymentId=" + clientPaymentId + ", autoAcceptQuote=" + autoAcceptQuote
                + ", expires=" + expires + ", notBefore=" + notBefore + ", notAfter=" + notAfter
    ...
    public static class Builder {
        ...
        public PaymentResponse build() {
            return new PaymentResponse(amount, currency, sourceToken, destinationToken, notes, memo,
                    purpose, clientPaymentId, autoAcceptQuote, expires, notBefore, notAfter, status,
                    links);
        }
    }
}
