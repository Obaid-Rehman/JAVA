...
import build.mypayquicker.platform.Environment;
import build.mypayquicker.platform.PQAPIV2Client;
import build.mypayquicker.platform.testing.HttpCallbackCatcher;
...
public class BaseControllerTest {
     ...
     */
    protected static PQAPIV2Client createConfigurationFromEnvironment() {
        PQAPIV2Client.Builder builder = new PQAPIV2Client.Builder();

        final String environment = System.getenv("PQAPIV_2_LIB_ENVIRONMENT");
        final String timeout = System.getenv("PQAPIV_2_LIB_TIMEOUT");
     ...
     */
    protected static PQAPIV2Client createConfiguration() {
        // Set Configuration parameters for test execution
        PQAPIV2Client config = createConfigurationFromEnvironment();
